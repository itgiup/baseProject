...
import { API, ITEM_NAME, ROLES, SEARCH_COLUMNS, FilmState } from "./constant";
import type { ColumnsType, TablePaginationConfig } from "antd/es/table";
import { FilterValue, SorterResult } from "antd/es/table/interface";
import { Table, Row, Col, Space, Card, Button, Tooltip, message, Dropdown, Checkbox, MenuProps, Input, DatePicker } from "antd";
...
const Film = () => {
  ...
  const TABLE_COLUMNS: ColumnsType<FilmState> = [{
    title: "Title",
    dataIndex: "title",
    key: "title",
    sorter: true,
